...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50 bg-gradient-to-br from-blue-50 to-white p-4">
      <div className="w-full max-w-md !max-w-md bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
        <div className="text-center mb-8">
          <div className="flex justify-center mb-2">
            <svg className="w-12 h-12 max-w-[3rem] max-h-[3rem] text-blue-600" viewBox="0 0 100 100" fill="currentColor">
          ...
          <div className="mb-4 relative">
            <div className="flex items-center border border-green-500 rounded-md overflow-hidden">
              <div className="pl-3 pr-2 text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 max-h-5 max-w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            {isLoading ? (
              <div className="flex items-center justify-center">
                <svg className="animate-spin -ml-1 mr-2 h-4 w-4 max-h-4 max-w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
